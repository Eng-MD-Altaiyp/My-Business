...
class Assginmets extends StatefulWidget {
  const Assginmets({Key? key}) : super(key: key);

  @override
  State<Assginmets> createState() => _AssginmetsState();
}

class _AssginmetsState extends State<Assginmets> {
  ...
  Future<List> getData() async {
    final response = await http.get(Uri.parse(
        "$URL_IP/MyBusiness/AppFile/getdata.php?type=assginmets"));
        ...
        onPressed: () {
          setState(
              ...
              Navigator.of(context).push(
                MaterialPageRoute(
                  builder: (context) => Add_Works(type: 'assginmets',),
                ),
              );
            },
          );
